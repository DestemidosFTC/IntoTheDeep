...
public class AutonomoSystem extends MecanumDrive {
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(9.0, 0, 0.8);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(9.0, 0, 0.8);

    public static double LATERAL_MULTIPLIER = 51.0 / 42.5 ;
    ...
    public AutonomoSystem(HardwareMap hardwareMap) {
